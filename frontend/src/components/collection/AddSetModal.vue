    ...
    <div class="modal-overlay" @click.self="$emit('close')">
        <div class="modal">
            ...
            <div class="modal-body">
                ...
                <div class="input-row">
                    <input v-model="setNumber" placeholder="e.g. 75192" class="set-input" @keyup.enter="handleAdd" />
                    <button class="add-btn" @click="handleAdd" :disabled="loading || !setNumber.trim()">
